...
export class AddUserComponent implements OnInit {
  ...
  public checkNullFieldValue(fieldValue: any): any {
    if((typeof fieldValue == "string" && fieldValue.trim()=="") || fieldValue==null || fieldValue==undefined) {
      return null;
    }
    return fieldValue;
  }
  ...
  addUser():void{
    ...
    let userObj = new User(userId,this.checkNullFieldValue(formValue.username), this.checkNullFieldValue(formValue.email), this.checkNullFieldValue(formValue.mobile), this.checkNullFieldValue(formValue.country),this.checkNullFieldValue(formValue.userType),true, new Date().getTime() );
